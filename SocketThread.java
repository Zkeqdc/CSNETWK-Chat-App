...
public class SocketThread implements Runnable{
    ...
    public SocketThread(Socket socket, newServerForm main) {
        this.main = main;
        this.socket = socket;
    ...
    private void createConnection(String receiver, String sender, String filename) {
        try {
            main.appendMessage("[createConnection]: create file sharing connection");
            ...
            if (s != null) { // Client đã tồn tại
                ...
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver + "'user not found.!");
            }
        } catch (IOException e) {
