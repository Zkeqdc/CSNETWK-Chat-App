 ...
 * @author james
 */
public class newServerForm extends javax.swing.JFrame {
    ...
    ServerSocket server;
    /**
     * Creates new form newServerForm
     */
        ...
        for(int x=0; x < clientFileSharingUsername.size(); x++){
            if(clientFileSharingUsername.elementAt(x).equals(username)){
                try {
                    ...
                    appendMessage("[FileSharing]: cannot cancel"+ username);
                }
                break;
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newServerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newServerForm().setVisible(true);
            }
        });
    }
